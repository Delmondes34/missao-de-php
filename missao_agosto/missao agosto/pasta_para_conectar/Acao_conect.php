...
if(isset($_POST['novaHist'])){
    ...
    if($generos==$genero){
        $genero = mysqli_fetch_object($_POST["$generos->id_generos ,$generos->genero"]);
    }
    ...
    $sql = "INSERT INTO historias(nome_da_historia, id_genero, historia) VALUES ('$nomDaHis',' $verGene','$historia') ";
